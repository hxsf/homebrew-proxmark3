class ProxmarkFirmwarePm5 < Formula
  desc "RRG/Iceman firmware for Proxmark5"
  ...
  bottle do
    ...
    sha256 cellar: :any_skip_relocation, arm64_tahoe:   "f054df16220f827988500cf3175b917c76f467b54b5d74ff8de5da1b7de986a2"
    sha256 cellar: :any_skip_relocation, arm64_sequoia: "d6f3fd33625eb38a409c64b2fc55848f676b1391fe412ef9ffcd0ddfbc89815b"
  end
  ...
  def caveats
    firmware = opt_share/"proxmark3/firmware/pm5"
    <<~EOS
      Firmware for Proxmark5 is installed in:
        #{firmware}
      ...
      Use a client matching the firmware version. Device-specific launchers:
        pm3-flash-pm5-bootrom
        pm3-flash-pm5-fullimage
        pm3-flash-pm5-all
